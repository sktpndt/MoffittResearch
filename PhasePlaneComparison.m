...
%calculate & plot red & green regions
...
mu = 0.02; % more exhaustion
delta = 0.03; % less clearance
...
B.de.margin = 5
   B.fontsize = 8;
   legend off
    B.export('PhasePlaneComparison.tiff','-w320','-h250', '-rp')