...
initCond = [c1_AT/max(c1_T)*20, c1_T/max(c1_T)*20]; % correction with scalar value
%initCond = [c1_AT/max(c1_AT), c1_T/max(c1_T)*1000]; % correction to get it on a good scale

figure(1);clf
%% Case 1: Mu sweep w/ % classification
...
% actual inital conditions %

c2_percs_rho = param_sweep(0, 0.3, 10, "rho", initCond)
