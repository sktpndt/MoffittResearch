...
figure(1);clf
% use m_vec = [0.1000, 0.7333, 1.3667, 2.0000]
...
axis([0 22 0 30]);
title('\delta = \delta x 0.1', FontSize=15);

% simulates initial conditions 
initCond = [0.2, 100; % Tumor resolution
            0.5, 300; % Tumor resolution
...
% Make the plot a little prettier
axis([0 22 0 30]);
title('\delta = \delta x 0.7333', FontSize=15);
...
% Make the plot a little prettier
axis([0 22 0 30]);
title('\delta = \delta x 1.3667', FontSize=15);
...
% Make the plot a little prettier
axis([0 22 0 30]);
title('\delta = \delta x 2.0', FontSize=15);
