...
axis([0 22 0 30]);
title('\alpha = \alpha x 0.7', FontSize=15);
...
% Make the plot a little prettier
axis([0 22 0 30]);
title('\alpha = \alpha x 0.9', FontSize=15);
...
% Make the plot a little prettier
axis([0 22 0 30]);
title('\alpha = \alpha x 1.1', FontSize=15);
...
% Make the plot a little prettier
axis([0 22 0 30]);
title('\alpha = \alpha x 1.3', FontSize=15);
