...
figure(1);clf
% use m_vec = [0.9, 1.0333, 1.1667, 1.3]
...
axis([0 22 0 30]);
title('\beta = \beta x 0.9', FontSize=15);
...
% Make the plot a little prettier
axis([0 22 0 30]);
title('\beta = \beta x 1.0333', FontSize=15);
...
% Make the plot a little prettier
axis([0 22 0 30]);
title('\beta = \beta x 1.1667', FontSize=15);
...
%% m_vec = 1.3 --> separatrix stalls out, not sure if good/bad
subplot(2,2,4)
%subplot(1,1,1)
m_vec = 1.3
...
% Make the plot a little prettier
axis([0 22 0 30]);
title('\beta = \beta x 1.3', FontSize=15);
